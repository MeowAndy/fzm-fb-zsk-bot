...
## bot-0.0.5 — 2026-09-18

### AstrBot 插件命令清单显式化

- 重新克隆并对照源码核对 7 个 AstrBot 插件的全部命令注册：qqadmin 48 条、relationship 14 条、qqprofile 6 条、PhoebeHub 8 条+触发词、Help Typst 4 条、mcskin 1 条、群导出 2 条——知识库此前已全覆盖，无遗漏。
- 为第 2–8 节每个 AstrBot 插件添加“完整命令清单”块：全部命令 + 别名 + 参数 + 一句话说明，与游戏插件节的呈现方式统一，一眼可见全部指令。
- qqadmin 清单按成员管理/消息与群资料/违禁词与风控/进群审核/群友与群文件/配置六组组织，48 条命令含全部别名。
